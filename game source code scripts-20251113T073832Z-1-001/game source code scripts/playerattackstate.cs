...
public class playerattackstate : playerbasestate
{
    ...
    public playerattackstate(playerstatemeachine playerstatemeachine,int attackindex) : base(playerstatemeachine)
    {
    ...
    {
        playerstatemeachine.animator.CrossFadeInFixedTime(slash,attack.transistionduration);
